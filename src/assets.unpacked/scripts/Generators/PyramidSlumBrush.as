class PyramidSlumBrush : DungeonBrush
{
	...
	PyramidSlumBrush()
	{
		...
		m_deco_wall.insertLast(Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_h_crack_1.unit"));
		m_deco_wall.insertLast(Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_h_crack_2.unit"));
		m_deco_wall.insertLast(Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_h_crack_3.unit"));
		m_deco_wall.insertLast(Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_h_crack_4.unit"));
		m_deco_wall.insertLast(Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_h_crack_5.unit"));
		m_deco_wall.insertLast(Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_h_pillar_large.unit"));
		m_deco_wall.insertLast(Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_h_pillar_medium.unit"));
		
		m_deco_wall_small.insertLast(Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_h_pillar_small.unit"));
	...
	void Build(Scene@ scene) override
	{
		...
		auto arch = Resources::GetUnitProducer("doodads/walls/pyramid_slum/_deco_ceiling_support.unit");
		...
		auto t_default = Resources::GetTileset("tilesets/pyramid_slum_8.tileset");
		auto t_dirt = Resources::GetTileset("tilesets/pyramid_slum_16.tileset");
		//auto t_default_grass = Resources::GetTileset("tilesets/pyramid_slum_path.tileset");
		...
		DoLighting(scene, "pyramid_slum", 100);
